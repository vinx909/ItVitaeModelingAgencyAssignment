...
namespace ModelingAgency.Data.Service.Infrastructure.Sql.Migrations
{
    ...
    [Migration("20210625134001_NAWonModelAndClientAddition")]
    partial class NAWonModelAndClientAddition
    {
            ...
            modelBuilder.Entity("ModelingAgency.Data.Client", b =>
                {
                    ...
                    b.HasIndex("EditOfId")
                        .IsUnique()
                        .HasFilter("[EditOfId] IS NOT NULL");
            ...
            modelBuilder.Entity("ModelingAgency.Data.Client", b =>
                {
                    b.HasOne("ModelingAgency.Data.Client", "EditOf")
                        .WithOne()
                        .HasForeignKey("ModelingAgency.Data.Client", "EditOfId");
